...
public class ArtsmiaController {
    ...
    void handleCreaGrafo(ActionEvent event) {
    	...
    	boolean b = model.creaGrafo(anno) ;
    	if(b==true)
    		txtResult.appendText("Il grafo è connesso! \n");
    	else txtResult.appendText("Il grafo NON e' connesso");
    	
    	txtResult.appendText("\nLa mostra con più opere esposte è :\n");
    	txtResult.appendText(model.getMax().toString());
    }
